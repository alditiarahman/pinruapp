...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="<?= base_url; ?>/dist/img/logo-bawaslu.png" alt="Bawaslu Logo" class="brand-image img-square elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= base_url; ?>/dist/img/AdminLTELogo.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
